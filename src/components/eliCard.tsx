...
<div className="flex flex-col text-center mt-auto mb-auto w-full md:w-[20vw]">
          <h1 className={`${bebas.variable} font-sans text-red-800 text-4xl md:text-5xl font-bold uppercase`}>
            Elysium Wealth
          </h1>
          <p className="underline decoration-slate-700 text-left mt-4 md:mt-0 md:text-lg">
          I had an assigment to make a webpage to schedule appointments to any kind of stablishment, and a bank was the obvious pick for me.
          I love getting into especific markets and minsets, and making a fake bank was awesome for training, this was a great way to get out of the comfort zone and try new stuff.  
          </p>
        </div>
      </section>

      <section className="flex flex-col md:flex-row w-full md:w-[60vw] pt-[4vh] justify-evenly text-center mt-6">
        <div>
        ...
        <article className="flex flex-row self-center space-x-10 mt-6 md:mt-0">
          <div>
            <a
              href="https://github.com/BlskMax/Elysium-Wealth"
